...
#(this code is for an interface!) and periodically kicks off NVE simulations from the NPT
...
#ensemble. The below script applies to interfacial systems. 
...
def main(args):
  ...
  stateFileNPT, stateNPT = doSimNPT(top, systemRef, integratorRef, platform, prop, temperature, scalexy=False, state=stateFileNVT)

  #Now perform dynamics simulation to get dynamics - this is defined here, NOT in openmm_surface_affinities_lib.py
  numShellWaters, dipoleCosAng, timePoints = doSimDynamics(top, systemRef, integratorRef, platform, prop, temperature, scalexy=False, coupled=True, state=stateFileNPT)
  ...
  #Now perform dynamics simulation to get dynamics - this is defined here, NOT in openmm_surface_affinities_lib.py
  numShellWaters, dipoleCosAng, timePoints = doSimDynamics(top, systemRef, integratorRef, platform, prop, temperature, scalexy=False, coupled=False, state=stateFileNPT)
