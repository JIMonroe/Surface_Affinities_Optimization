...
from calc_fitness_lib import MDselect
from calc_fitness_lib import linregselect
from metric_models import *
from property_functions import gr_ch3
from property_functions import gr_oh
from sklearn import linear_model
from sklearn.preprocessing import StandardScaler

Usage="""python run_opt.py numHydroxyls soluteName1 soluteName2
  ...
  soluteName1 - the name of the solute to use as a prefix for grabbing .gro and .top files from FFfiles
  soluteName2 - the name of the second solute to use (need to calculate selectivity
"""
...
def main(args):
  ...
  try:
    ...
    print("Must provide the name (file prefix) for the TWO solutes you want to simulate.")
    print(Usage)
    sys.exit(2)
  ...
  for i_bin in range(15):
    property_gr_ch3 = rdfLinRegProperty(label='gr_ch3_'+str(i_bin), property_function=gr_ch3)
    initial_props.append(property_gr_ch3)
  for i_bin in range(15):
    property_gr_oh = rdfLinRegProperty(label='gr_oh_'+str(i_bin), property_function=gr_oh)
    initial_props.append(property_gr_oh)
  #lin_reg_model = linear_model.LinearRegression()
  #selectModel = rdfLinRegModel(initial_properties=initial_props, model=lin_reg_model)
  lasso_model = linear_model.Lasso(alpha=1e-4) # HARD CODING HERE
  scaler = StandardScaler()
  selectModel = rdfLinRegModel(initial_properties=initial_props, model=lasso_model, scaler=scaler, rmse_norm_threshold=0.9)
  ...
  doOptSAM(numOH, randGens-1, randGens, 
           MDselect, {'solNames':[soluteName1, soluteName2]}, 
           findMax=False, 
  ...
  doOptSAM(numOH, optGensMD+randGens-1, randGens, 
           MDselect, {'solNames':[soluteName1, soluteName2]}, 
           findMax=False, 
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  ...
  model_at_par = selectModel.build_model('structure_library.pkl')
  if not model_at_par:
    print("Model not passing criteria for doing well on test-set data, but ignoring warnings and using anyway.")
  with open('select_LinRegModel.pkl', 'w') as f_model:
    pickle.dump(selectModel, f_model)
  ...
  for i in range(1,5):
    ...
    #And do minimization
    doOptSAM(numOH, optGensModel+2*optGensMD+randGens-1, randGens, 
             linregselect, {'model':selectModel},
             findMax=False,
             CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
             OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
    #Move this somewhere safe
  ...
  combineLibraries(libList, libDirDict)
  doOptSAM(numOH, 6*optGensModel+2*optGensMD+randGens-1, randGens, 
           linregselect, {'model':selectModel},
           findMax=False,
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  ...
  combineLibraries(libList, libDirDict)
  doOptSAM(numOH, 12*optGensModel+2*optGensMD+randGens-1, randGens, 
           linregselect, {'model':selectModel},
           findMax=True,
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  ...
  doOptSAM(numOH, 12*optGensModel+3*optGensMD+randGens-1, randGens, 
           MDselect, {'solNames':[soluteName1, soluteName2]}, 
           findMax=False, 
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  doOptSAM(numOH, 12*optGensModel+4*optGensMD+randGens-1, randGens, 
           MDselect, {'solNames':[soluteName1, soluteName2]}, 
           findMax=True, 
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  ...
  shutil.move('select_LinRegModel.pkl', 'old_select_LinRegModel.pkl')
  model_at_par = selectModel.build_model('structure_library.pkl')
  if not model_at_par:
  ...
  for struct in thislib:
    if struct.metricpredicted:
      newmetric = selectModel.model_prediction(struct)
  ...
  doOptSAM(numOH, 14*optGensModel+4*optGensMD+randGens-1, randGens, 
           linregselect, {'model':selectModel}, 
           findMax=False, 
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
  doOptSAM(numOH, 16*optGensModel+4*optGensMD+randGens-1, randGens, 
           linregselect, {'model':selectModel}, 
           findMax=True, 
           CH3chainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/ctmSAM',
           OHchainFilePrefix='/home/jmonroe/Surface_Affinities_Project/FFfiles/otmSAM')
